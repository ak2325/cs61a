...
def taxicab(a, b):
    ...
    """
    "*** YOUR CODE HERE ***"
    diffstreet = abs(street(a)-street(b))
    diffavenue = abs(avenue(a)-avenue(b))
    return diffstreet + diffavenue
...
def count_change(amount):
    ...
    def contain(n,sub):
        if n < sub or n < 0:
            ...
            with_sub = contain(n-sub,sub)
            without_sub = contain(n,sub*2)
            return with_sub + without_sub
    return contain(amount,1)
