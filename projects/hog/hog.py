...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        res += res1
        num_rolls -= 1
    return res if pigflag == 0 else 1
    # END PROBLEM 1
...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        return False
    if score0 % score1 != 0 and  score1 % score0 != 0:
        return False
    return True
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_rolls <= 10:
        ...
        score = averaged_score(num_rolls,dice)
        if score > maxscore:
            maxscore = score
            maxidx = num_rolls
        num_rolls += 1
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    newscore = baconscore + score
    if newscore < opponent_score and is_swap(newscore, opponent_score):
        flag = 1
    if baconscore >= margin and not is_swap(newscore, opponent_score):
        flag = 1
    return 0 if flag else num_rolls  # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    1. roll 0 (bacon) when leads to beneficial swap
    2. roll 0 (bacon) when score increase larger than margin and not leads to a swap
    """
    # BEGIN PROBLEM 12
    newscore_bacon = score + free_bacon(opponent_score)
    if newscore_bacon > 100:
        return 0
    if score < opponent_score:
        if newscore_bacon > opponent_score:
            return bacon_strategy(score,opponent_score)
        elif opponent_score-score > 20:
            return 5
    if score > opponent_score:
        if score < 90 and is_swap(newscore_bacon,opponent_score+free_bacon(newscore_bacon)):
            return 4
        if score < 90 and is_swap(newscore_bacon,opponent_score+1):
            return 4
